				...
				<div style="border:1px solid black;height:auto;">
					...
					?>
						...
						<div style="float:right;width:550px;">
							...
							<form action="ubah-simpan-penjualan.php" method="POST">
							...
							<?php 
								...
								echo'
								<tr>
									<td><b>Nomor Tagihan	</b></td><td><input type="hidden" name="tagihan" value="'.$_GET['no_tagihan'].'">'.$_GET['no_tagihan'].'</td>
								</tr>
								<tr>
								...
								<tr>
									<td><b>Status Order</b></td><td><input required="required" type="radio" name="status" value="Belum Dibayar"/>Belum Dibayar &nbsp;<input required="required" type="radio" name="status" value="DiProses"/>DiProses &nbsp; <input required="required" type="radio" name="status" value="Dikirim"/>Dikirim &nbsp; <input required="required" type="radio" name="status" value="Selesai"/>Selesai</td>
								</tr>
								<tr>
									<td><b>Resi</b></td><td><input type="input" name="resi" value="'.$data["resi"].'"></td>
								</tr>
								<tr>
									<td></td><td><input type="submit" name="submit" value="Ubah" required> &nbsp; <a  href="penjualan.php" style = "margin-top:50px; text-decoration:none;" >Kembali</a></td>
								</tr>
								';
							?>
							</table>
